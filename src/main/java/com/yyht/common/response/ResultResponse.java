...
public class ResultResponse {
    ...
    public ResultResponse success(ResultMessage resultMessage, Object... args) {
    	ResultResponse resultResponse = new ResultResponse();
    	resultResponse.setMeta(new Meta(resultMessage.getCode(), String.format(resultMessage.getMessage(), args)));
    	resultResponse.setData(null);
        return resultResponse;
    }
     ...
     * @return ResultResponse
     */
    public ResultResponse failure(Object... args) {
    	ResultResponse resultResponse = new ResultResponse();
    	resultResponse.setMeta(new Meta(ResultMessage.FAILURE.getCode(), String.format(ResultMessage.FAILURE.getMessage(), args)));
    	resultResponse.setData(null);
        return resultResponse;
    }
...
//     * @return ResultResponse
//     */
//    public ResultResponse failure(ResultMessage resultMessage) {
//    	ResultResponse resultResponse = new ResultResponse();
//    	resultResponse.setMeta(new Meta(resultMessage!=null? resultMessage: ResultMessage.FAILURE));
//    	resultResponse.setData(null);
//        return resultResponse;
//    }
    ...
    public ResultResponse failure(ResultMessage resultMessage, Object... args) {
    	...
    	String msg = args.length>0? String.format(resultMessage.getMessage(), args): resultMessage.getMessage();
    	resultResponse.setMeta(new Meta(resultMessage.getCode(), msg));
    	resultResponse.setData(null);
        return resultResponse;
    }
